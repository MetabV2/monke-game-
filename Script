...
UIGradient_17.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(19, 143, 143)), ColorSequenceKeypoint.new(0.98, Color3.fromRGB(19, 143, 143)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0, 0, 0))}
...
UIGradient_20.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(19, 143, 143)), ColorSequenceKeypoint.new(0.98, Color3.fromRGB(19, 143, 143)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0, 0, 0))}
...
UIGradient_23.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(19, 143, 143)), ColorSequenceKeypoint.new(0.98, Color3.fromRGB(19, 143, 143)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0, 0, 0))}
...
UIAspectRatioConstraint_25.Parent = CloseButton
...
coroutine.wrap(UWNG_fake_script)()
local function WWEN_fake_script() -- Button_14.TABLE 
	local script = Instance.new('LocalScript', Button_14)
...
coroutine.wrap(WWEN_fake_script)()
local function PRBLEHB_fake_script() -- Button_14.METAB SCRIPT 
	local script = Instance.new('LocalScript', Button_14)
...
coroutine.wrap(PRBLEHB_fake_script)()
local function DVWMLZN_fake_script() -- Button_15.ANIMATION 
...
coroutine.wrap(DVWMLZN_fake_script)()
local function APIKPM_fake_script() -- Button_15.TABLE 
	local script = Instance.new('LocalScript', Button_15)
...
coroutine.wrap(APIKPM_fake_script)()
local function UZHL_fake_script() -- Button_15.METAB SCRIPT 
	local script = Instance.new('LocalScript', Button_15)
...
local function WIGN_fake_script() -- Button_16.ANIMATION 
...
coroutine.wrap(WIGN_fake_script)()
local function CNUIFGI_fake_script() -- Button_16.TABLE 
	local script = Instance.new('LocalScript', Button_16)
...
coroutine.wrap(CNUIFGI_fake_script)()
local function UJYZMK_fake_script() -- Button_16.METAB SCRIPT 
	local script = Instance.new('LocalScript', Button_16)
...
coroutine.wrap(UJYZMK_fake_script)()
local function NCJO_fake_script() -- Button_17.ANIMATION 
...
coroutine.wrap(NCJO_fake_script)()
local function LZIBGBO_fake_script() -- Button_17.TABLE 
	local script = Instance.new('LocalScript', Button_17)
...
coroutine.wrap(LZIBGBO_fake_script)()
local function BFKN_fake_script() -- Button_18.ANIMATION 
...
coroutine.wrap(BFKN_fake_script)()
local function PYXF_fake_script() -- Button_18.TABLE 
	local script = Instance.new('LocalScript', Button_18)
...
coroutine.wrap(PYXF_fake_script)()
local function DNDKOU_fake_script() -- Button_18.METAB SCRIPT 
	local script = Instance.new('LocalScript', Button_18)
...
coroutine.wrap(DNDKOU_fake_script)()
local function RCYZUS_fake_script() -- Button_19.ANIMATION 
...
coroutine.wrap(RCYZUS_fake_script)()
local function LMYCDJ_fake_script() -- Button_19.TABLE 
	local script = Instance.new('LocalScript', Button_19)
...
coroutine.wrap(LMYCDJ_fake_script)()
local function EZLIOBO_fake_script() -- Button_19.METAB SCRIPT 
	local script = Instance.new('LocalScript', Button_19)
...
coroutine.wrap(EZLIOBO_fake_script)()
local function XPMZRC_fake_script() -- Button_20.ANIMATION 
...
coroutine.wrap(XPMZRC_fake_script)()
local function GYWK_fake_script() -- Button_20.TABLE 
	local script = Instance.new('LocalScript', Button_20)
...
coroutine.wrap(GYWK_fake_script)()
local function LNMQCSK_fake_script() -- Button_20.METAB SCRIPT 
	local script = Instance.new('LocalScript', Button_20)
...
coroutine.wrap(LNMQCSK_fake_script)()
local function PAKIEJ_fake_script() -- CloseButton.LocalScript 
...
coroutine.wrap(PAKIEJ_fake_script)()
local function LVNZLH_fake_script() -- CloseButton.ANIME 
	local script = Instance.new('LocalScript', CloseButton)
...
coroutine.wrap(LVNZLH_fake_script)()
local function KPLPC_fake_script() -- ImageLabel.DEPLACE  
...
coroutine.wrap(KPLPC_fake_script)()
